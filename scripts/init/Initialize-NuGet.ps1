...
. "$PSScriptRoot\Initialize-InstallFromNuget.ps1" -OutDir $toolsDir -DownloadFeed $authHelperDownloadFeed -PackageName $authHelperPackageName -targetFileName $authHelperExeName
